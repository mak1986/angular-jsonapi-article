(function() {
	...
	function MachineNameController($routeParams, CONFIG, CrudUtility, ResourceManager) {

		var vm = CrudUtility.init(this, 'machine_name');
	...
	angular
		.module('_Controllers')
		.controller('MachineNameController', MachineNameController);
})();