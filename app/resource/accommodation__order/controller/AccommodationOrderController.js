(function() {
	...
	function AccommodationOrderController($routeParams, CONFIG, CrudUtility, ResourceManager) {

		var vm = CrudUtility.init(this, 'accommodation__order');
	...
	AccommodationOrderController.$inject = [
		'$routeParams',
		'CONFIG',
		'CrudUtility',
		'ResourceManager'
	...
	angular
		.module('_Controllers')
		.controller('AccommodationOrderController', AccommodationOrderController);
})();