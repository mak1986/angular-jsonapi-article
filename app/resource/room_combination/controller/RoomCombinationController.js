(function() {
	...
	function RoomCombinationController($routeParams, CONFIG, CrudUtility, ResourceManager) {

		var vm = CrudUtility.init(this, 'room_combination');
	...
	RoomCombinationController.$inject = [
		'$routeParams',
		'CONFIG',
		'CrudUtility',
		'ResourceManager'
	...
	angular
		.module('_Controllers')
		.controller('RoomCombinationController', RoomCombinationController);
})();