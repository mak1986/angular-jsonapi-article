(function() {
	...
	function AccommodationLuxuryTitleController($routeParams, CONFIG, CrudUtility, ResourceManager) {

		var vm = CrudUtility.init(this, 'accommodation_luxury_title');
	...
	AccommodationLuxuryTitleController.$inject = [
		'$routeParams',
		'CONFIG',
		'CrudUtility',
		'ResourceManager'
	...
	angular
		.module('_Controllers')
		.controller('AccommodationLuxuryTitleController', AccommodationLuxuryTitleController);
})();