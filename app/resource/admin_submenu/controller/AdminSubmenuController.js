(function() {
	...
	function AdminSubmenuController($routeParams, CONFIG, CrudUtility, ResourceManager) {

		var vm = CrudUtility.init(this, 'admin_submenu');
	...
	angular
		.module('_Controllers')
		.controller('AdminSubmenuController', AdminSubmenuController);
})();