	...
	function PaymentController($filter, $routeParams, CONFIG, CrudUtility, ResourceManager, UserInterface) {
		...
		this.setEvents = function() {
			...
			for (paymentId in UserInterface.site.payments) {
				...
				order = $filter('hookFilterByFirstRelationship')(UserInterface.site.payments[paymentId].order);
				console.log(order);
				if ($filter('hookFilterByFirstRelationship')(order.site).id == UserInterface.site.id) {
