(function() {
	...
	function AccommodationKindController($routeParams, CONFIG, CrudUtility, ResourceManager) {

		var vm = CrudUtility.init(this, 'accommodation_kind');
	...
	AccommodationKindController.$inject = [
		'$routeParams',
		'CONFIG',
		'CrudUtility',
		'ResourceManager'
	...
	angular
		.module('_Controllers')
		.controller('AccommodationKindController', AccommodationKindController);
})();